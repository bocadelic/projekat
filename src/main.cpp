...
struct ProgramState {
    glm::vec3 dirLightSettings = glm::vec3(0.1f, 0.15f,0.3f);
...
int main() {
    ...
    // -----------
    //mansion
    Model mansionModel("resources/objects/Mansion/export.obj");
    mansionModel.SetShaderTextureNamePrefix("material.");
    //shark
    Model sharkModel("resources/objects/WhiteShark/WhiteShark.obj");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        ourShader.setVec3("dirLight.ambient", glm::vec3(programState->dirLightSettings.x));
        ourShader.setVec3("dirLight.diffuse", glm::vec3(programState->dirLightSettings.y));
        ourShader.setVec3("dirLight.specular", glm::vec3(programState->dirLightSettings.z));
        //pointlight 1
        ...
        //mansion
        glm::mat4 modelMansion = glm::mat4(1.0f);
        modelMansion = glm::translate(modelMansion,glm::vec3(0.0f,-0.5f,0.0f));
        modelMansion = glm::scale(modelMansion, glm::vec3(0.4f));
        ourShader.setMat4("model", modelMansion);
        mansionModel.Draw(ourShader);
        //sharks
        glm::mat4 modelShark = glm::mat4(1.0f);
        modelShark = glm::translate(modelShark,glm::vec3(-10.0f+7*(sin(currentFrame)*0.5f+0.5f),-0.45f,-11.4f+1.8f*(sin(currentFrame*3)*0.5f+0.5f)));
        modelShark = glm::scale(modelShark, glm::vec3(0.2f));
        modelShark = glm::rotate(modelShark,glm::radians(90.0f), glm::vec3(0.0f ,1.0f, 0.0f));
        ourShader.setMat4("model", modelShark);
        sharkModel.Draw(ourShader);

        modelShark = glm::mat4(1.0f);
        modelShark = glm::scale(modelShark, glm::vec3(0.2f));
        modelShark = glm::translate(modelShark,glm::vec3(-26.0f,-2.0f,-53.0f));
        modelShark = glm::rotate(modelShark,glm::radians(currentFrame*40.0f), glm::vec3(0.0f ,1.0f, 0.0f));
        modelShark = glm::translate(modelShark,glm::vec3(-3.8f,0.0f,0.0f));
        ourShader.setMat4("model", modelShark);
        sharkModel.Draw(ourShader);

        modelShark = glm::mat4(1.0f);
        modelShark = glm::translate(modelShark,glm::vec3(-6.0f,-2.0f-5*(sin(currentFrame)*0.5f+0.5f),-13.0f));
        modelShark = glm::scale(modelShark, glm::vec3(1.15f));
        modelShark = glm::rotate(modelShark,glm::radians(-50.0f), glm::vec3(1.0f ,0.0f, 0.0f));
        ourShader.setMat4("model", modelShark);
        sharkModel.Draw(ourShader);
...
void DrawImGui(ProgramState *programState) {
...

    {
        ...
        ImGui::DragFloat3("Direction light settings", (float*)&programState->dirLightSettings, 0.05, 0.001, 1.0);
